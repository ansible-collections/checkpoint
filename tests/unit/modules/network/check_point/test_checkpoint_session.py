...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch(
            "ansible_collections.checkpoint.checkpoint.plugins.modules.checkpoint_session.Connection"
        )
    ...
    def get_session_200(self, mocker):
        mock_function = mocker.patch(
            "ansible_collections.checkpoint.checkpoint.plugins.modules.checkpoint_session.get_session"
        )
