...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch(
            "ansible_collections.checkpoint.checkpoint.plugins.modules.checkpoint_access_rule.Connection"
        )
    ...
    def get_access_rule_200(self, mocker):
        mock_function = mocker.patch(
            "ansible_collections.checkpoint.checkpoint.plugins.modules.checkpoint_access_rule.get_access_rule"
        )
