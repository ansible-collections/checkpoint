...
UPDATE_PAYLOAD = {
    "name": "New_Standard_Package_1",
    "access_layers": {"add": [{"name": "New Access Layer 1", "position": 1}]},
    "threat_layers": {"add": [{"name": "New Layer 1", "position": 2}]},
}

OBJECT_AFTER_UPDATE = UPDATE_PAYLOAD

DELETE_PAYLOAD = {"name": "New_Standard_Package_1", "state": "absent"}
