...
from ansible_collections.checkpoint.checkpoint.tests.unit.compat import (
    unittest,
)
...
from ansible_collections.checkpoint.checkpoint.plugins.httpapi.checkpoint import (
    HttpApi,
)
