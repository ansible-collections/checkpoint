...
DOCUMENTATION = """module: cp_mgmt_group_facts
...
options:
  ...
  show_as_ranges:
    description:
    - When true, the group's matched content is displayed as ranges of IP addresses
      rather than network objects.<br />Objects that are not represented using IP
      addresses are presented as objects.<br />The 'members' parameter is omitted
