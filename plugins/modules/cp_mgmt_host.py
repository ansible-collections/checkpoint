...
DOCUMENTATION = """module: cp_mgmt_host
short_description: Manages host objects on Check Point over Web Services API
description:
- Manages host objects on Check Point devices including creating, updating and removing
  objects.
...
options:
  ...
  interfaces:
    ...
    suboptions:
      ...
      subnet:
        description:
        - IPv4 or IPv6 network address. If both addresses are required use subnet4
          and subnet6 fields explicitly.
        type: str
      subnet4:
        description:
    ...
    suboptions:
      ...
      ip_address:
        ...
        - IPv4 or IPv6 address. If both addresses are required use ipv4-address and
          ipv6-address fields explicitly. This parameter is not required in case "method"
          parameter is "hide" and "hide-behind" parameter is "gateway".
        type: str
      ipv4_address:
        description:
        - IPv4 address.
      ...
      hide_behind:
        description:
        - Hide behind method. This parameter is not required in case "method" parameter
          is "static".
        type: str
        choices:
        - gateway
    ...
    suboptions:
      ...
      web_server_config:
        ...
        suboptions:
          ...
          protected_by:
            description:
            - Network object which protects this server identified by the name or
              UID.
            type: str
  color:
    description:
