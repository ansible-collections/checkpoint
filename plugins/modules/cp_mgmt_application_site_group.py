...
DOCUMENTATION = """module: cp_mgmt_application_site_group
short_description: Manages application-site-group objects on Check Point over Web
  Services API
description:
- Manages application-site-group objects on Check Point devices including creating,
...
options:
  ...
  members:
    description:
    - Collection of application and URL filtering objects identified by the name or
      UID.
    type: list
  tags:
    description:
