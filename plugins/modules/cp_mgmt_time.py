...
DOCUMENTATION = """module: cp_mgmt_time
short_description: Manages time objects on Check Point over Web Services API
description:
- Manages time objects on Check Point devices including creating, updating and removing
  objects.
...
options:
  name:
    ...
    description:
    - End time. Note, Each gateway may interpret this time differently according to
      its time zone.
    type: dict
    suboptions:
      date:
      ...
      iso_8601:
        description:
        - Date and time represented in international ISO 8601 format. Time zone information
          is ignored.
        type: str
      posix:
        description:
  ...
  hours_ranges:
    description:
    - Hours recurrence. Note, Each gateway may interpret this time differently according
      to its time zone.
    type: list
    suboptions:
      enabled:
  ...
  start:
    description:
    - Starting time. Note, Each gateway may interpret this time differently according
      to its time zone.
    type: dict
    suboptions:
      date:
  ...
  recurrence:
    ...
    suboptions:
      days:
        description:
        - Valid on specific days. Multiple options, support range of days in months.
          Example,["1","3","9-20"].
        type: list
      month:
        description:
