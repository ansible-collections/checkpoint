...
DOCUMENTATION = """module: cp_mgmt_application_site_category
short_description: Manages application-site-category objects on Check Point over Web
  Services API
description:
- Manages application-site-category objects on Check Point devices including creating,
