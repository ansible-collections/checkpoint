...
DOCUMENTATION = """module: cp_mgmt_security_zone
short_description: Manages security-zone objects on Check Point over Web Services
  API
description:
- Manages security-zone objects on Check Point devices including creating, updating
