...
DOCUMENTATION = """module: cp_mgmt_threat_protection_override
...
options:
  ...
  overrides:
    description:
    - Overrides per profile for this protection<br> Note, Remove override for Core
      protections removes only the action's override. Remove override for Threat Cloud
      protections removes the action, track and packet captures.
    type: list
    suboptions:
      action:
        description:
