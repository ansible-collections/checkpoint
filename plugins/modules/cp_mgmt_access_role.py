...
DOCUMENTATION = """module: cp_mgmt_access_role
short_description: Manages access-role objects on Check Point over Web Services API
description:
- Manages access-role objects on Check Point devices including creating, updating
...
options:
  ...
  machines:
    ...
    suboptions:
      ...
      base_dn:
        description:
        - When source is "Active Directory" use "base-dn" to refine the query in AD
          database.
        type: str
  networks:
    description:
    - Collection of Network objects identified by the name or UID that can access
      the system.
    type: list
  ...
  users:
    ...
    suboptions:
      source:
        description:
        - Active Directory name or UID or Identity Tag  or Internal User Groups or
          LDAP groups or Guests.
        type: str
      selection:
        description:
        - Name or UID of an object selected from source.
