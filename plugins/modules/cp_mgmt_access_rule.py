...
DOCUMENTATION = """module: cp_mgmt_access_rule
short_description: Manages access-rule objects on Check Point over Web Services API
description:
- Manages access-rule objects on Check Point devices including creating, updating
    ...
    argument_spec = dict(
        ...
        vpn=dict(
            ...
            options=dict(
                ...
                directional=dict(
                    type="list", options=dict(to=dict(type="str"))
                ),
            ),
        ),
