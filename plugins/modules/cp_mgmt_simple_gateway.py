...
DOCUMENTATION = """module: cp_mgmt_simple_gateway
short_description: Manages simple-gateway objects on Check Point over Web Services
  API
description:
- Manages simple-gateway objects on Check Point devices including creating, updating
