...
DOCUMENTATION = """module: cp_mgmt_service_dce_rpc
short_description: Manages service-dce-rpc objects on Check Point over Web Services
  API
description:
- Manages service-dce-rpc objects on Check Point devices including creating, updating
