...
DOCUMENTATION = """module: cp_mgmt_dynamic_object
short_description: Manages dynamic-object objects on Check Point over Web Services
  API
description:
- Manages dynamic-object objects on Check Point devices including creating, updating
