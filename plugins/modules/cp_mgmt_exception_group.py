...
DOCUMENTATION = """module: cp_mgmt_exception_group
short_description: Manages exception-group objects on Check Point over Web Services
  API
description:
- Manages exception-group objects on Check Point devices including creating, updating
...
options:
  ...
  apply_on:
    description:
    - An exception group can be set to apply on all threat rules, all threat rules
      which have a specific profile, or those rules manually chosen by the user.
    type: str
    choices:
    - all-threat-rules
