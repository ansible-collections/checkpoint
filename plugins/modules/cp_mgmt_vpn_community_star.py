...
DOCUMENTATION = """module: cp_mgmt_vpn_community_star
short_description: Manages vpn-community-star objects on Check Point over Web Services
  API
description:
- Manages vpn-community-star objects on Check Point devices including creating, updating
...
options:
  ...
  center_gateways:
    description:
    - Collection of Gateway objects representing center gateways identified by the
      name or UID.
    type: list
  encryption_method:
    description:
  ...
  satellite_gateways:
    description:
    - Collection of Gateway objects representing satellite gateways identified by
      the name or UID.
    type: list
  shared_secrets:
    description:
