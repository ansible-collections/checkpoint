...
DOCUMENTATION = """module: cp_mgmt_service_group
short_description: Manages service-group objects on Check Point over Web Services
  API
description:
- Manages service-group objects on Check Point devices including creating, updating
