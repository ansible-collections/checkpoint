...
DOCUMENTATION = """module: cp_mgmt_group_with_exclusion
short_description: Manages group-with-exclusion objects on Check Point over Web Services
  API
description:
- Manages group-with-exclusion objects on Check Point devices including creating,
